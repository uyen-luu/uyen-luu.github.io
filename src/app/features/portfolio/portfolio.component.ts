...
export class PortfolioComponent {
  ...
  projects: Card[] = [
    ...
    },
    {
      ...
      pictures: [
        '../../assets/pokedex_01.png',
        '../../assets/pokedex_02.png',
        '../../assets/pokedex_03.png',
        '../../assets/pokedex_04.png',
        '../../assets/pokedex_05.png',
        '../../assets/pokedex_06.png',
        '../../assets/pokedex_07.png',
      ],
    },
    {
      id: 4,
      name: 'TeamTrack',
      summary:
        'TeamTrack is an application for visualizing projects with "open" status to keep track of your customers and activities.',
      description:
        'TeamTrack was developed by me with the aim of facilitating project, customer, and task management, offering an intuitive interface and requested functionalities, similar to a watchdog. The combination of Spring Boot on the backend and Vue.js on the frontend provides an efficient application that is easy to maintain. We hope this system meets your needs and facilitates tracking your daily activities.',
      ...
      pictures: [
        '../../assets/teamtrack_06.png',
        '../../assets/teamtrack_07.png',
        '../../assets/teamtrack_08.png',
        '../../assets/teamtrack_09.png',
        '../../assets/teamtrack_10.png',
      ],
    },
    {
      id: 5,
      ...
      summary:
        'A responsive and dynamic portfolio website designed and developed by Barbara Calderon.',
      description:
      ...
      pictures: [
        '../../assets/portfolio_01.png',
        '../../assets/portfolio_02.png',
        '../../assets/portfolio_03.png',
        '../../assets/portfolio_04.png',
        '../../assets/portfolio_05.png',
      ],
    },
    {
      id: 6,
    ...
    },
    {
      ...
      summary:
        'This project is a RESTful API for managing a simple library. It uses JDK 17 and PostgreSQL for the database with the specified database schema.',
      description:
    ...
    },
    {
      ...
      name: 'Gradebook',
      summary:
        'Gradebook is a simple web application for managing student registration, their grades, and subjects.',
      description:
      ...
      pictures: [
        '../../assets/gradebook_01.png',
        '../../assets/gradebook_02.png',
        '../../assets/gradebook_03.png',
        '../../assets/gradebook_04.png',
      ],
    },
    {
      id: 18,
